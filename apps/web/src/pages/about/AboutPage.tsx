  ...
  return (
    <PageLayout title="About Us | Lola's Rentals" fullBleed floralScrollFreezeRef={gallerySectionRef}>
      <SEO
        ...
        description="Learn about Lola's Rentals & Tours, Siargao Island's premium scooter, motorbike and tuktuk rental company. Based in General Luna since 2019. Proud supporter of local NGOs on Siargao."
