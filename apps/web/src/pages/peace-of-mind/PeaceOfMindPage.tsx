        ...
        <section className="w-full bg-[#f1e6d6]">
          <FadeUpSection onlyAnimateOnMobile>
            <div className="bg-[#f1e6d6] px-6 pt-20 pb-6 text-center">
              ...
              <PageHeader
                headingMain={t('peaceOfMind.headingMain')}
                headingAccent={t('peaceOfMind.headingAccent')}
                subheading={t('peaceOfMind.subheading')}
        ...
        <div className="mx-auto max-w-7xl px-4 md:px-6">
            ...
            <AnimatedPanel delay={0}>
              <div className="rounded-xl bg-teal-brand p-5 shadow-sm">
                <div className="mb-3 flex items-center gap-3">
                  ...
                  <h2 className="font-headline text-lg !text-white">{t('peaceOfMind.covered')}</h2>
                </div>
                <div>
                  <CoveredRow>{t('peaceOfMind.coveredItems.scratches')}</CoveredRow>
                  <CoveredRow>{t('peaceOfMind.coveredItems.brokenPanels')}</CoveredRow>
                  <CoveredRow>{t('peaceOfMind.coveredItems.tyres')}</CoveredRow>
                  <CoveredRow>{t('peaceOfMind.coveredItems.theft')}</CoveredRow>
                  <CoveredRow>{t('peaceOfMind.coveredItems.accessories')}</CoveredRow>
                  <CoveredRow>{t('peaceOfMind.coveredItems.vandalism')}</CoveredRow>
                </div>
              </div>
            </AnimatedPanel>
            ...
            <AnimatedPanel delay={0.08}>
              <div className="rounded-xl bg-[#C0392B] p-5 shadow-sm">
                <div className="mb-3 flex items-center gap-3">
                  ...
                  <h2 className="font-headline text-lg !text-white">{t('peaceOfMind.notCovered')}</h2>
                </div>
                <div>
                  <NotCoveredRow>{t('peaceOfMind.notCoveredItems.reckless')}</NotCoveredRow>
                  <NotCoveredRow>{t('peaceOfMind.notCoveredItems.structural')}</NotCoveredRow>
                  <NotCoveredRow>{t('peaceOfMind.notCoveredItems.loss')}</NotCoveredRow>
                  <NotCoveredRow>{t('peaceOfMind.notCoveredItems.personal')}</NotCoveredRow>
                </div>
              </div>
            </AnimatedPanel>
          </div>
          ...
          <section className="mt-4 rounded-xl border border-amber-200 bg-amber-50 p-4">
            <h2 className="mb-2 flex items-center gap-2 font-headline text-base text-amber-800">
              ...
              {t('peaceOfMind.conditions')}
            </h2>
            <ul className="list-none space-y-1.5 pl-0 font-lato text-xs leading-snug text-amber-900/80">
              <li className="flex gap-2">
                <span aria-hidden>•</span>
                <span>{t('peaceOfMind.condition1')}</span>
              </li>
              <li className="flex gap-2">
                <span aria-hidden>•</span>
                <span>{t('peaceOfMind.condition2')}</span>
              </li>
              <li className="flex gap-2">
                <span aria-hidden>•</span>
                <span>{t('peaceOfMind.condition3')}</span>
              </li>
            </ul>
          </section>
          ...
          <section className="mt-6 text-center">
            <p className="mb-3 font-lato text-sm text-charcoal-brand/60">{t('peaceOfMind.questions')}</p>
            <a
              href={WHATSAPP_URL}
              target="_blank"
