...
DO $$
BEGIN
  EXECUTE 'REVOKE EXECUTE ON FUNCTION public.collect_payment_atomic(text, text, text, numeric, text, text, date, text, text, text, text, date, jsonb, text) FROM authenticated';
  EXECUTE 'REVOKE EXECUTE ON FUNCTION public.collect_payment_atomic(text, text, text, numeric, text, text, date, text, text, text, text, date, jsonb, text) FROM anon';
  EXECUTE 'GRANT EXECUTE ON FUNCTION public.collect_payment_atomic(text, text, text, numeric, text, text, date, text, text, text, text, date, jsonb, text) TO service_role';
END $$;
