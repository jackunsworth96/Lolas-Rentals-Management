-- ============================================================
-- 090: Fix ambiguous order_id in process_raw_order_atomic (step 13).
-- RETURNS TABLE(order_id, ...) collides with payments.order_id in the
-- UPDATE ... WHERE order_id IS NULL predicate.
-- ============================================================
