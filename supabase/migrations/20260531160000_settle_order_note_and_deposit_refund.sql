-- ============================================================
-- Settle order RPC: combine return-charge notes + deposit-refund payments
--
-- Migration 128 added p_return_charges_note, but the later
-- deposit-refund migration redefined settle_order_atomic without that
-- argument. The API now passes both p_return_charges_note and
-- p_deposit_refund_payment, so the database function must expose both.
-- ============================================================
