...
--
-- Supabase CLI v2.72 can mis-handle this historical migration when
-- it contains several top-level CREATE FUNCTION statements. Keep the
-- migration as one top-level DO statement so fresh local databases can
